...
import {addForumPost, getForumCategory} from '../api/request';
import Spinner from 'react-native-spinkit';
import I18n from '../language/i18n';
import {userStorage} from '../utils/Storage';
import {colors} from './../style/colors';
export default class AddForum extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      images: [],
      ...
      <View style={{flex: 1, backgroundColor: '#fff'}}>
        ...
        <TouchableOpacity
          ...
          <View style={styles.push}>
            <Text style={styles.pushtext}>{I18n.t('publishing')}</Text>
          </View>
        </TouchableOpacity>
      </View>
    );
